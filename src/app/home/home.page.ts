...
// import { LinkyService } from 'ngx-linky';
...
export class HomePage {
  ...
  sendWhatsApp() {
    ...
    (Device as any)['getInfo']().then((info: any) => {
      if (info.platform === 'web') {
        // Handle web platform
        const phoneNumber = '1234567890'; // Ganti dengan nomor tujuan WhatsApp Anda
        const message = 'Hello, this is the WhatsApp message.';
        ...
        // Handle other platforms
        // Pastikan aplikasi WhatsApp terinstal di perangkat
        const phoneNumber = '1234567890'; // Ganti dengan nomor tujuan WhatsApp Anda
        const message = 'Hello, this is the WhatsApp message.';
        const encodedMessage = encodeURIComponent(message);
